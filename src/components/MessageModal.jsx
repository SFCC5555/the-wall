...
const MessageModal = () => {
  ...
  return (
    <div className="fixed top-0 w-full h-screen bg-black/75 z-10 flex items-center justify-center p-5">
        <section className="relative w-full sm:w-3/4 md:w-3/5 bg-white rounded-sm p-5 flex flex-col gap-2" >
              ...
              <div className="flex gap-3">
                ...
                <section className="w-1/2 flex gap-2" >
                  <div className="w-1/2 flex flex-col gap-2" >
                    ...
                    <div>
                      <button id="font" type="button" className={`w-full border-2 border-gray-200 hover:border-black py-1 px-1 sm:px-2 text-sm sm:text-base font-semibold italic ${font}-font`} onClick={()=>setFontMenuStatus(prev=>!prev)}>{font[0].toUpperCase()}{font.slice(1)}</button>
                  ...
                  <div className="w-1/2 flex flex-col gap-2" >
                    ...
                    <div>
                      <button id="color" type="button" className={`w-full border-2 border-gray-200 hover:border-black py-1 px-1 sm:px-2 text-sm sm:text-base font-semibold italic ${color}-color`} onClick={()=>setColorMenuStatus(prev=>!prev)}>{color[0].toUpperCase()}{color.slice(1)} <i className="bi bi-pencil-fill" /></button>
